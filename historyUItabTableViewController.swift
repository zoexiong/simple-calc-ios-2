//
//  historyUItabTableViewController.swift
//  simple-calc-ios-2
//
//  Created by Just on 16/11/5.
...
var historyCells:[String] = []
    func loadHistoryItems() {
        var i:Int = 0
        while i < history_list.count{
        historyCells.append(history_list[history_list.count-i-1])
            i += 1
        }
        print("load cells func loaded")
    }
...
//        return history_list.count
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let historyCell = historyCells[indexPath.row]
        cell.historyLabel.text = historyCell
        return cell
    }
